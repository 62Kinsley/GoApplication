...
const file_laptop_message_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_message.proto\x12\fpackage_name\x1a\x17processor_message.proto\x1a\x14memory_message.proto\x1a\x14screen_message.proto\x1a\x16keyboard_message.proto\x1a\x15storage_message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8c\x04\n" +
	"\x06Laptop\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05brand\x18\x02 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12#\n" +
	"\x03cpu\x18\x04 \x01(\v2\x11.package_name.CPUR\x03cpu\x12&\n" +
	"\x03ram\x18\x05 \x01(\v2\x14.package_name.MemoryR\x03ram\x12%\n" +
	"\x04gpus\x18\x06 \x03(\v2\x11.package_name.GPUR\x04gpus\x12/\n" +
	"\astorage\x18\a \x03(\v2\x15.package_name.StorageR\astorage\x12,\n" +
	"\x06screen\x18\b \x01(\v2\x14.package_name.ScreenR\x06screen\x122\n" +
	"\bkeyboard\x18\t \x01(\v2\x16.package_name.KeyboardR\bkeyboard\x12\x1d\n" +
	"\tweight_kg\x18\n" +
...
var file_laptop_message_proto_goTypes = []any{
	(*Laptop)(nil),                // 0: package_name.Laptop
	(*CPU)(nil),                   // 1: package_name.CPU
	(*Memory)(nil),                // 2: package_name.Memory
	(*GPU)(nil),                   // 3: package_name.GPU
	(*Storage)(nil),               // 4: package_name.Storage
	(*Screen)(nil),                // 5: package_name.Screen
	(*Keyboard)(nil),              // 6: package_name.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: package_name.Laptop.cpu:type_name -> package_name.CPU
	2, // 1: package_name.Laptop.ram:type_name -> package_name.Memory
	3, // 2: package_name.Laptop.gpus:type_name -> package_name.GPU
	4, // 3: package_name.Laptop.storage:type_name -> package_name.Storage
	5, // 4: package_name.Laptop.screen:type_name -> package_name.Screen
	6, // 5: package_name.Laptop.keyboard:type_name -> package_name.Keyboard
	7, // 6: package_name.Laptop.updated_at:type_name -> google.protobuf.Timestamp
