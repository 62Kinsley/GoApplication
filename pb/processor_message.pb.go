...
const file_processor_message_proto_rawDesc = "" +
	"\n" +
	"\x17processor_message.proto\x12\fpackage_name\x1a\x14memory_message.proto\"\x9f\x01\n" +
	"\x03CPU\x12\x14\n" +
	...
	"\amax_ghz\x18\x06 \x01(\x01R\x06maxGhz\"\x8f\x01\n" +
	"\x03GPU\x12\x14\n" +
	"\x05brand\x18\x01 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x17\n" +
	"\amin_ghz\x18\x05 \x01(\x01R\x06minGhz\x12\x17\n" +
	"\amax_ghz\x18\x06 \x01(\x01R\x06maxGhz\x12,\n" +
	"\x06memory\x18\a \x01(\v2\x14.package_name.MemoryR\x06memoryB\x06Z\x04./pbb\x06proto3"
...
var file_processor_message_proto_goTypes = []any{
	(*CPU)(nil),    // 0: package_name.CPU
	(*GPU)(nil),    // 1: package_name.GPU
	(*Memory)(nil), // 2: package_name.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: package_name.GPU.memory:type_name -> package_name.Memory
