...
type Keyboard struct {
	...
	Layout        Keyboard_Layout        `protobuf:"varint,1,opt,name=layout,proto3,enum=package_name.Keyboard_Layout" json:"layout,omitempty"`
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\fpackage_name\"\x96\x01\n" +
	"\bKeyboard\x125\n" +
	"\x06layout\x18\x01 \x01(\x0e2\x1d.package_name.Keyboard.LayoutR\x06layout\x12\x18\n" +
	...
	"\n" +
	"\x06QWERTZ\x10\x03B\x06Z\x04./pbb\x06proto3"
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: package_name.Keyboard.Layout
	(*Keyboard)(nil),     // 1: package_name.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: package_name.Keyboard.layout:type_name -> package_name.Keyboard.Layout
