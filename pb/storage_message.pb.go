...
type Storage struct {
	...
	Driver        Storage_Driver         `protobuf:"varint,1,opt,name=driver,proto3,enum=package_name.Storage_Driver" json:"driver,omitempty"`
...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\fpackage_name\x1a\x14memory_message.proto\"\x96\x01\n" +
	"\aStorage\x124\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x1c.package_name.Storage.DriverR\x06driver\x12,\n" +
	"\x06memory\x18\x02 \x01(\v2\x14.package_name.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: package_name.Storage.Driver
	(*Storage)(nil),     // 1: package_name.Storage
	(*Memory)(nil),      // 2: package_name.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: package_name.Storage.driver:type_name -> package_name.Storage.Driver
	2, // 1: package_name.Storage.memory:type_name -> package_name.Memory
