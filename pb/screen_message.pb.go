...
type Screen struct {
	...
	Panel         Screen_Panel           `protobuf:"varint,3,opt,name=panel,proto3,enum=package_name.Screen_Panel" json:"panel,omitempty"`
...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\fpackage_name\"\xfd\x01\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x12?\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2\x1f.package_name.Screen.ResolutionR\n" +
	"resolution\x120\n" +
	"\x05panel\x18\x03 \x01(\x0e2\x1a.package_name.Screen.PanelR\x05panel\x1a:\n" +
	"\n" +
	"Resolution\x12\x14\n" +
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: package_name.Screen.Panel
	(*Screen)(nil),            // 1: package_name.Screen
	(*Screen_Resolution)(nil), // 2: package_name.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: package_name.Screen.resolution:type_name -> package_name.Screen.Resolution
	0, // 1: package_name.Screen.panel:type_name -> package_name.Screen.Panel
